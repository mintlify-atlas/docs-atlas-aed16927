...
**Current Display**:
- Placeholder with growth preview message
- Coming soon: Line graphs and bar charts
...
- Member attendance frequency distribution

<Note>
  Attendance data is collected from the bookings table. Future updates will visualize this data for trend analysis.
</Note>
...
```
CAC = Total Marketing Spend ÷ New Members
```

Rule: CAC should be < 1/3 of LTV
